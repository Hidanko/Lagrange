...
public class Tabela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tablePrincipal.getColumnModel().getColumnCount() > 0) {
            ...
            tablePrincipal.getColumnModel().getColumn(0).setPreferredWidth(1);
            tablePrincipal.getColumnModel().getColumn(0).setMaxWidth(27);
